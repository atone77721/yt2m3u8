...
def grab(url: str):
    """
Grabs the live-streaming M3U8 file and saves it to playlist.m3u8
    """
    if '&' in url:
        url = url.split('&')[0]
    ...
    while True:
        if 'https://' in response[end - tuner: end]:
            ...
            m3u8_url = link[start:end]
            print(f"{m3u8_url}")

            # ✅ Save to playlist.m3u8
